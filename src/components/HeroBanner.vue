...
/* animation for circle_circle_img */
@keyframes rotateImg {
  from {
...
/* animation for react-reveal */
@keyframes react-reveal-1 {
  from {
...
/* responsive styles for mobile -> media queries */
